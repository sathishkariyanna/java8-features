...
Using this class we can easily check whether a variable has null value
or not and by doing this we can avoid the NullPointerException. 

Different methods in optional are : isPresent(), ifPresent(), orElse(),
orElseGet(), optional.map, optional.flatMap.
